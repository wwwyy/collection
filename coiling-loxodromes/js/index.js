...
// this creates the "twist". Here is what it would look like with twelve points and different `angle` values http://imgur.com/a/5FmOn
...
function loop() {
	...
	for(i = 0, l = circles.length; i < l; i++) {
		...
		for(j = 0; j < segmentsPerCircle; j++) {
			...
			// (this is basically the same difference as when you read CSS transformations, cf this post http://codepen.io/bali_balo/post/chaining-transforms)
